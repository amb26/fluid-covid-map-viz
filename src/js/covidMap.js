...
fluid.mapviz.covid.renderers = {
    ...
    distance: function (torender) {
        var inMiles = torender / hortis.metresInMile;
...
fluid.defaults("fluid.mapviz.covid.map", {
    gradeNames: ["hortis.leafletMap", "hortis.streetmapTiles", "hortis.CSVLeafletMap"],
    colours: {
        accessible: "#0f0",
        inaccessible: "#f00"
    },
...
fluid.mapviz.covid.queryCentres = function (that) {
    ...
    var cutoffInMetres = query.radius * hortis.metresInMile;
